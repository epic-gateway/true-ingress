...
./service_start.sh ${NODE} ${SERVICE_IP2} ${SERVICE_PORT} ${SERVICE_ID2} ${SERVICE}
...
echo -e "\n### CURL from '${NODE}' to ${SERVICE_IP2}:${SERVICE_PORT}"
./http_check.sh ${NODE} ${SERVICE_IP2} ${SERVICE_PORT} ${SERVICE_ID2}
