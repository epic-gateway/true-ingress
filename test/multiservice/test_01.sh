...
./service_start.sh ${NODE} ${SERVICE_IP} ${SERVICE_PORT2} ${SERVICE_ID2} ${SERVICE}
...
echo -e "\n### CURL from '${NODE}' to ${SERVICE_IP}:${SERVICE_PORT2}"
./http_check.sh ${NODE} ${SERVICE_IP} ${SERVICE_PORT2} ${SERVICE_ID2}
