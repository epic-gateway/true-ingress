...
docker exec -it ${NODE} bash -c "cli_cfg set eth1 0 1 9 'NODE1 RX' && cli_cfg set eth1 1 1 8 'NODE1 TX' && cli_cfg get all"
...
docker exec -it ${NODE} bash -c "cli_tunnel set ${SERVICE_ID} 172.1.0.4 6080 172.1.0.3 6080 && cli_tunnel get all"
