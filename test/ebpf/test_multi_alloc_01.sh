...
docker exec -it ${PROXY} bash -c "/tmp/.acnodal/bin/port_init.sh ${PROXY_PORT_MIN} ${PROXY_PORT_MAX}"
...
docker exec -it ${NODE} bash -c "/tmp/.acnodal/bin/port_init.sh ${NODE_PORT_MIN} ${NODE_PORT_MAX}"
