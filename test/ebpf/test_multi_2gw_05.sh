...
if [ "${VERBOSE}" ]; then
    ...
    docker exec -it ${NODE2} bash -c "pfc_start.sh ${NODE_NIC2} "${NODE2}" 9 8 ${NODE_PORT_MIN2} ${NODE_PORT_MAX2} ${DELAY2}"
    ...
    echo "  ${NODE2}"
    docker exec -it ${NODE2} bash -c "pfc_start.sh ${NODE_NIC2} "${NODE2}" 9 8 ${NODE_PORT_MIN2} ${NODE_PORT_MAX2} ${DELAY}" > /dev/null
fi
...
if [ "${VERBOSE}" ]; then
    ...
    docker exec -it ${PROXY2} bash -c "pfc_add.sh ${PROXY_NIC2} ${GROUP_ID} ${SERVICE_ID2} ${PASSWD2} 0 0 ${SERVICE_PROTO2} ${PROXY_IP2} ${PROXY_PORT2} ${SERVICE_IP2} ${SERVICE_PORT2}"
    PROXY_TUN_PORT2=$(docker exec -it ${PROXY2} bash -c "cli_tunnel get ${TUNNEL_ID2}" | grep ${TUNNEL_ID2} | awk '{print $3}' | sed 's/:/ /g' | awk '{print $2}')
    docker exec -it ${NODE2} bash -c "pfc_add.sh -p ${NODE_NIC2} ${GROUP_ID} ${SERVICE_ID2} ${PASSWD2} ${PROXY_TUN_IP2} ${PROXY_TUN_PORT2} ${SERVICE_PROTO2} ${PROXY_IP2} ${PROXY_PORT2} ${SERVICE_IP2} ${SERVICE_PORT2}"

    docker exec -it ${PROXY} bash -c "pfc_list.sh"
    docker exec -it ${PROXY2} bash -c "pfc_list.sh"
    docker exec -it ${NODE} bash -c "pfc_list.sh"
    docker exec -it ${NODE2} bash -c "pfc_list.sh"
else
    ...
    docker exec -it ${PROXY2} bash -c "pfc_add.sh ${PROXY_NIC2} ${GROUP_ID} ${SERVICE_ID2} ${PASSWD2} 0 0 ${SERVICE_PROTO2} ${PROXY_IP2} ${PROXY_PORT2} ${SERVICE_IP2} ${SERVICE_PORT2}" > /dev/null
    PROXY_TUN_PORT2=$(docker exec -it ${PROXY2} bash -c "cli_tunnel get ${TUNNEL_ID2}" | grep ${TUNNEL_ID2} | awk '{print $3}' | sed 's/:/ /g' | awk '{print $2}')
    docker exec -it ${NODE2} bash -c "pfc_add.sh -p ${NODE_NIC2} ${GROUP_ID} ${SERVICE_ID2} ${PASSWD2} ${PROXY_TUN_IP2} ${PROXY_TUN_PORT2} ${SERVICE_PROTO2} ${PROXY_IP2} ${PROXY_PORT2} ${SERVICE_IP2} ${SERVICE_PORT2}" > /dev/null
fi
...
if [ "${VERBOSE}" ]; then
    ...
    docker exec -it ${NODE2} bash -c "pfc_delete.sh ${GROUP_ID} ${SERVICE_ID2}"
    ...
    docker exec -it ${NODE2} bash -c "pfc_stop.sh ${NODE_NIC2}"
    ...
    docker exec -it ${NODE2} bash -c "pfc_delete.sh ${GROUP_ID} ${SERVICE_ID2}" > /dev/null
    ...
    docker exec -it ${NODE2} bash -c "pfc_stop.sh ${NODE_NIC2}" > /dev/null
